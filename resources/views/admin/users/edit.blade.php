        ...
        <div class="container mh-100 ">
            ...
            <div class="form">
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                          <div class="col">
                            <div class="form-outline">
                              <input type="text" id="nom" class="form-control" name="nom" value="{{ $user->name }}"/>
                              @error('nom')
                        ...
                        <!-- tele input -->
                        <div class="form-outline mb-4">
                            <input type="tel" id="tele" class="form-control" name="tele" value="{{ $user->phone }}"/>
                            @error('tele')
                                <div class="text-danger text-sm">{{ $message }}</div> 
                            @enderror
                        ...
                        <div class="d-flex  justify-content-start gap-3 align-items-center mb-4">
                            ...
                            <a class="btn btn-primary mb-4 "href="{{ route('admin.payments.create',  ['user' => $user]) }}">go to payment</a>
                        </div>
                        <!-- Register buttons -->
