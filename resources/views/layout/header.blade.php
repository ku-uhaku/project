    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                <a class="nav-link dropdown-toggle btn btn-primary py-4 px-lg-5 d-none d-lg-block text-light" href="#" id="userDropdown" role="button"
            ...
            @else
            <a href="{{ route('login-form') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Se Connecter
